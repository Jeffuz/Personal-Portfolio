...
const Navbar = () => {
    ...
    return (
        <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-[#85F4FF]'>
            ...
            <div className={nav ? 'fixed left-0 top-0 w-[50%] h-full border-r border-r-gray-100  bg-[#EFFFFD] ease-in-out duration-500' : 'fixed left-[-100%] top-0 w-[50%] h-full border-r border-r-gray-100  bg-[#EFFFFD] ease-in-out duration-500'}>
