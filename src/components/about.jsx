        ...
        <div>
            ...
            <div id='about_content' className='text-slate-400 leading-7 text-md font-medium flex flex-col gap-4'>
                <div>
                    ...
                    <span className='about_bold_importance'> <a href='https://about.google/' target='_blank'>Google</a> </span> was recommneded to me
                ...
                <div>
                    ...
                    Additionally, I have explored AI engineering by developing applications like 
                    <span className='about_bold_importance'> <a href='https://github.com/Jeffuz/Eyes2Ears' target='_blank'>Eyes2Ears</a></span>
                    , a mobile app that assists visually impaired individuals using advanced AI technologies, and 
